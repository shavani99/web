<?php
    ...
    if (ISSET($_POST['forgotPassword'])) {
        ...
        $check_email = "SELECT email FROM webdurga_signup WHERE email='$email'";
        ...
        if ($email_count>0) {
            ...
            if (mail($to, $subject, $message, $body)) {
                ?>
                    <script>
                        window.location.replace("verifyme.php");
                    </script>
                <?php
            }else {
                ?>
            ...
            ?>
                <script>
                    alert("Oops Sorry! Please enter valid credentials.");
...
<head>
    ...
    <title>Foggot Password - Web Durga</title>
                        ...
                        <div class="verification-form">
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                ...
                                <div class="col-12 text-center">
                                    <button type="submit" class="btn btn-success px-5 py-2" name="forgotPassword">Send OTP</button>
                                </div>
                            </form>
                        </div>
                    </div>
