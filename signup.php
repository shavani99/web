<?php
    ...
    if (ISSET($_POST['signup'])) {
        ...
        $register = "CREATE TABLE IF NOT EXISTS webdurga_signup (
        ...
        if ($conn->query($register) === TRUE) {
            ...
            if ($email_count>0) {
                ...
                $status = "inactive";
                $insert_data = "INSERT INTO webdurga_signup (username, email, mobile, password, token, status) VALUES ('$username', '$email', '$mobile', '$hash_password', '$token', '$status')";
                ...
                if ($conn->query($insert_data) === TRUE) {
                    ...
                    $to = $email;
                    $subject = "Welcome to Web Durga.";
                    $message = "Thank you for registering with Web Durga, I hope you enjoy Web Durga's services.<br>Your verification OTP is " . $token;
        ...
        <section id="signup">
            <div class="container-fluid">
                <div class="row px-2 px-md-5">
                    <div class="col-12 col-md-4 bg-light shadow-lg px-3 py-4 p-md-5 rounded">
                        <div class="signup-form">
                            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" autocomplete="off">
                                ...
                                <div class="col-12 text-center">
                                    <button type="submit" class="btn btn-primary px-5 py-2" name="signup">Sign up</button>
                                </div>
                                <div class="col-12 text-center pt-4">
                                    <p>If already have an account please <a href="login.php">log in</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
